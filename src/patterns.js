export const PATTERNS = [
  {
    ...
    confidence: "high",
    score: 10,
    regex: /\b(?:module not found|cannot find module|modulenotfounderror|could not resolve|failed to resolve|package .* not found)\b/i,
  },
  {
    category: "compiler",
    confidence: "high",
    score: 10,
    regex: /(?:\berror\s+TS\d+\b|\berror\[[A-Z]\d+\]|\bsyntaxerror\b|compilation failed)/i,
  },
  {
    category: "runtime",
    confidence: "high",
  ...
  },
  {
    ...
    confidence: "high",
    score: 8,
    regex: /(?:\btests? failed\b|^\s*(?:FAIL|FAILED)\b)/i,
  },
  {
    category: "runtime",
    confidence: "high",
